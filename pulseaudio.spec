...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587590552
...
cp %{_builddir}/pulseaudio-13.0/LICENSE %{buildroot}/usr/share/package-licenses/pulseaudio/146b824cf04e121da67545caff4ede65bbbb3936
cp %{_builddir}/pulseaudio-13.0/src/pulsecore/filter/LICENSE.WEBKIT %{buildroot}/usr/share/package-licenses/pulseaudio/24b8a642abc0e34765a795aef5ce10475e17574b
pushd ../build32/
%make_install32
